...
- Two or more [dedicated servers](https://www.ovhcloud.com/asia/bare-metal/) (compatible with vRack)
...
Once the vRack is activated in your account, go to the `Bare Metal Cloud`{.action} section of your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), click on `Network`{.action} and open the `vRack`{.action} menu.
